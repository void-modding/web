	...
	return (
		<div className="h-screen overflow-y-auto scroll-smooth bg-[#0f1115] text-white font-sans">
			<header className="sticky top-0 z-50 flex justify-between items-center px-8 py-6 bg-[#0f1115]/90 backdrop-blur border-b border-white/5">
        		...
        		<nav>
          			<a href="https://github.com/void-modding/web" className="text-sm opacity-80 hover:opacity-100 transition">Documentation</a> {/*We need to add the docs page, github has a wiki we could use that*/}
        		</nav>
      		</header>
      		...
      		<main className="flex flex-col items-center text-center mt-10 px-4">
				...
				<section className="w-full max-w-5xl flex flex-col md:flex-row items-center justify-between mt-20">
					<div className="max-w-lg text-left">
						<h2 className="text-3xl font-semibold mb-2">Find what you need,<br/><span className="text-cyan-400">whenever you need</span></h2>
						<p className="opacity-70 text-sm">
							Search through thousands of mods spanning across hundreds of games instantly.
							Filter by category, popularity and more.
						</p>
					</div>

					<div>
						<img src="Placeholder.png"></img> {/* I guess we adding an image here */}
					</div>
				</section>
				...
				<section className="w-full max-w-5xl flex flex-col md:flex-row items-center justify-between mt-20">
					...
					<div className="max-w-lg text-left">
						<h2 className="text-3xl font-semibold mb-2">Automaticlly installs<br/><span className="text-cyan-400">for you</span></h2>
						<p className="opacity-70 text-sm">
							Automaticly installs mods for you with a single click.
							No more manual installs, no more broken mods.
						</p>
					</div>
				</section>
      		</main>
